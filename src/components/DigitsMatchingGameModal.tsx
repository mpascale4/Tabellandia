              ...
              >
                ...
                <div className="pt-2">
                  <button
                    ...
                    className="px-8 py-3.5 bg-amber-400 hover:bg-amber-300 text-amber-950 font-black text-sm sm:text-base rounded-2xl shadow-xl hover:scale-105 active:scale-95 transition-transform cursor-pointer inline-flex items-center gap-2 font-sans animate-pulse"
                  >
