...
export const WORLDS_DATA: WorldConfig[] = [
  {
    ...
    itemsToCount: "🦢",
    monuments: [
      { id: "m2_1", name: "Roccia del Piccone", cost: 15, description: "Ripristina l'antico simbolo del Piccone inciso nella pietra, il primo segno che Orion riconoscerà.", emoji: "⛏️🪨" },
      { id: "m2_2", name: "Lago di Cristallo", cost: 30, description: "Rigenera il lago dalle acque immobili dove Orion vede il suo riflesso e riconosce il suo duplice destino.", emoji: "🪞💧" },
      { id: "m2_3", name: "Altare delle Ali", cost: 50, description: "Ricostituisce il santuario dove vengono venerate le ali dispiegate del Cigno Predestinato.", emoji: "🏛️✨" }
    ]
  },
  {
    id: 3,
    ...
    itemsToCount: "💶",
    monuments: [
      { id: "m3_1", name: "Nicchia della Moneta Incisa", cost: 20, description: "Illumina il profilo della Moneta Rara inciso nella roccia, il simbolo che Orion riconosce immediatamente.", emoji: "💶✨" },
      { id: "m3_2", name: "Specchio di Cristallo", cost: 35, description: "Ripristina le acque specchianti dove la Moneta e le sue ali si riflettono come doppio destino.", emoji: "🪞💧" },
      { id: "m3_3", name: "Cripta dei Segreti", cost: 60, description: "Sblocca la camera segreta dove dormono i ricordi incisi delle ali dispiegate del Cigno.", emoji: "🏛️🔐" }
    ]
  },
  {
    id: 4,
    ...
    itemsToCount: "🪑",
    monuments: [
      { id: "m4_1", name: "Emersione della Sedia", cost: 25, description: "Riporta in superficie la Sedia Magica dalle profondità del lago di sale, rivelando il suo marchio dell'Infinito.", emoji: "🪑💎" },
      { id: "m4_2", name: "Tempio del Riflesso", cost: 40, description: "Restaura le acque immobili dove la Sedia e il Cigno si riflettono in doppio, raddoppiando la verità.", emoji: "🪞✨" },
      { id: "m4_3", name: "Altare dell'Infinito", cost: 70, description: "Ricompone il santuario dove il marchio dell'Infinito brilla sullo schienale della Sedia, centro di tutto il potere.", emoji: "♾️🏛️" }
    ]
  },
  {
    id: 5,
    ...
    itemsToCount: "🐍",
    monuments: [
      { id: "m5_1", name: "Ponte di Cristallo Sommerso", cost: 30, description: "Ricostruisce un magico ponte sospeso sotto l'acqua dove Bobo guida i viaggiatori.", emoji: "🌉💧" },
      { id: "m5_2", name: "Caverna Sacra di Bobo", cost: 45, description: "Restaura il santuario sotterraneo dove il Serpente Guida impartisce la sua saggezza silenziosa.", emoji: "🐍🕌" },
      { id: "m5_3", name: "Miniera dei Segni Incisi", cost: 80, description: "Riattiva i passaggi della miniera dove ogni pietra racconta un indizio del cammino di Orion.", emoji: "⛏️✨" }
    ]
  },
  {
    id: 6,
    ...
    itemsToCount: "🐌",
    monuments: [
      { id: "m6_1", name: "Caverna dei Consigli Incisi", cost: 35, description: "Riattiva la camera sacra dove le parole di Lina sono scolpite nella pietra, rivelando il cammino.", emoji: "🏛️📜" },
      { id: "m6_2", name: "Fonte della Saggezza", cost: 50, description: "Ripristina le acque cristalline dove la voce di Lina risuona come eterna guida.", emoji: "💧✨" },
      { id: "m6_3", name: "Porta della Fede", cost: 90, description: "Ricostruisce la soglia magica dove chi si siede sulla Sedia e ascolta comprende finalmente la verità.", emoji: "🚪🪑" }
    ]
  },
  {
    id: 7,
    ...
    itemsToCount: "⚡",
    monuments: [
      { id: "m7_1", name: "Roccia dell'Infinito Illuminato", cost: 40, description: "Riporta in vita il marchio dell'Infinito sulla roccia, che brilla nel bagliore del Fulmine.", emoji: "♾️⚡" },
      { id: "m7_2", name: "Altare dei Segni Rivelati", cost: 55, description: "Ripristina il santuario dove ogni fulmine rivela un nuovo segno inciso nella pietra.", emoji: "⛩️✨" },
      { id: "m7_3", name: "Osservatorio del Cielo", cost: 100, description: "Ricostruisce la postazione dove i Fulmini trasmettono i loro messaggi luminosi verso le stelle.", emoji: "🔭⚡" }
    ]
  },
  {
    id: 8,
    ...
    itemsToCount: "♾️",
    monuments: [
      { id: "m8_1", name: "Basamento dell'Infinito", cost: 45, description: "Riporta in luce il simbolo dell'Infinito inciso sotto la Sedia Magica, il cuore stesso di tutta la Terra Magica.", emoji: "♾️🏛️" },
      { id: "m8_2", name: "Camera della Chiave Doppia", cost: 60, description: "Ricostituisce la cripta dove due Infiniti sovrapposti formano la chiave della porta finale.", emoji: "🔑✨" },
      { id: "m8_3", name: "Centrale del Potere Eterno", cost: 110, description: "Ricollega il flusso dell'Infinito che mantiene il legame tra tutti i mondi e i personaggi di Tabellandia.", emoji: "🌀💫" }
    ]
  },
  {
    id: 9,
    ...
    itemsToCount: "🎈",
    monuments: [
      { id: "m9_1", name: "Roccia del Piccone Finale", cost: 50, description: "Risveglia il Piccone inciso sulla roccia dove i due Palloncini Rossi fluttuano immobili, annunciando la rivelazione.", emoji: "⛏️🎈" },
      { id: "m9_2", name: "Porta della Verità", cost: 70, description: "Ricostituisce la soglia segreta dove la roccia cede e rivela il simbolo dell'Infinito e le ali di Orion.", emoji: "🚪✨" },
      { id: "m9_3", name: "Santuario del Destino Compiuto", cost: 120, description: "Ricongiungi il luogo sacro dove Orion ha finalmente riconosciuto se stesso come il Cigno Predestinato scritto nella pietra eterna.", emoji: "♾️🦢" }
    ]
  }
];
